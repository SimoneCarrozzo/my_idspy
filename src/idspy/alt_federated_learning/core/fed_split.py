...
class IdentifyTopHosts_alt(Step):
    """
...
class FederatedSplits_alt(Step):
    """
...
class ApplyFitAwareToFederatedSplits_alt(Step):
    def __init__(
        self,
...
class AggregatedTestSet_alt(Step):
    """
